...
while (input) {
  ...
  var lolos = {
    robotic: ['Dadan Hidayatuloh', 'Stephanie Claudia', 'Lenyen Nandha Galuhsusan', 'Joel Pangaribuan'],
    scientificResearch: ['Muhammad Rizal Nurromdhoni', 'Reynaldi Ariza'],
  ...
  } else if (p == lolos.scientificResearch[0] || p == lolos.scientificResearch[1]) {
